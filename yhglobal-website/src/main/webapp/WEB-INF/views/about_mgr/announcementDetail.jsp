	    	...
	    	<div class="col-md-10">
	    		<div class="panel panel-default">
				  ...
				  <div class="panel-body">
			          ...
			          <div>
							<div align="center">${announcementData.webAnnTheme}</div>
							<h5></h5>
					        <div>${announcementData.webAnnContent}</div>
					        <h5></h5>
					        <div align="right">发布时间：<fmt:formatDate value="${announcementData.createTime}" type="both"/></div>
				      </div>
