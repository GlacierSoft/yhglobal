					      ...
					      <div class="panel-body">
					        <div class="btn-group-vertical">
					          <ul class="nav nav-pills nav-stacked" id="u2" style="max-width: 300px;text-align: center;">
						          ...
						          <li class="active" style="width: 120px;"><a href="${ctx}/member/belaidup.htm?p=1"  class="btn btn-info" role="button">运单记录</a></li>
					      ...
					      <div class="panel-body">
								<div class="btn-group-vertical">
									<ul class="nav nav-pills nav-stacked" id="u2"
										...
										<li style="width: 120px;"><a href="${ctx}/memberStatistics/memberStatistics.htm" class="btn btn-info" role="button">会员统计信息</a></li>
									</ul>
								</div>
							</div>
					  </div>
