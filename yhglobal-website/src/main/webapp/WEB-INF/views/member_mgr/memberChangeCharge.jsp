	...
	<div class="container">
		<div class="row">
							...
							<div class="panel-body">
								<div class="btn-group-vertical">
									<ul class="nav nav-pills nav-stacked" id="u2"
										...
										<li class="active" style="width: 120px;"><a href="${ctx}/member/changeChargePassword.htm" class="btn btn-info" role="button">交易密码修改</a></li>
									</ul>
								</div>
							</div>
						</div>
			...
			<div class="col-md-10">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">交易密码修改</h3>
					</div>
					<div class="panel-body">
						<div class="row"
							style="width: 70%; height: 300px; margin: 0 auto; border-radius: 5px;">
							<div class="panel panel-default">
								<div class="panel-body">
									...
									<form action="" id="changeChargeForm">
