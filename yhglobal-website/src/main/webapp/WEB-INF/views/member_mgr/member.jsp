					    ...
					    <div id="collapseOne" class="panel-collapse collapse in">
					      <div class="panel-body">
					        <div class="btn-group-vertical">
					          <a href="${ctx}/member/index.htm" class="btn btn-info" role="button">会员信息</a>
					          <a href="${ctx}/member/release.htm" <%-- onclick="checkRechargeWithdraw('${currentMember.memberId}','${ctx}/financeMember/rechargeWithdraw.htm?p=1');" --%> class="btn btn-default" role="button">发布货源</a>
					          <a href="#" <%-- onclick="checksMember('${currentMember.memberId}','${ctx}/member/memberAuth.htm?&p=0');" --%> class="btn btn-default" role="button">货源管理</a>
							  ...
							  <a href="${ctx}/member/memberDetail.htm" class="btn btn-default" role="button">会员详细信息</a>
