...
function sendAllProvinceAjax() { 
	$.ajax({
		type: "get",
		url: 'http://localhost:8080/yhglobal-website/resources/area/js/queryAllProvinces.js',
		async: false,
		dataType: "json",
		success: function(data) {
...
function sendAllCitiesAjax() { 
	$.ajax({
		type: "get",
		url: 'http://localhost:8080/yhglobal-website/resources/area/js/queryCities.js',
		async: false,
		dataType: "json",
		success: function(data) {
...
function sendAllCountiesAjax()
 { 
	$.ajax({
		type: "get",
		url: "http://localhost:8080/yhglobal-website/resources/area/js/queryAllAreas.js",
		async: false,
		dataType: "json",
		success: function(data) {
			allAreas = data.areas;
