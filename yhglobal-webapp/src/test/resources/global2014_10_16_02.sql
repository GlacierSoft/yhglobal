...
INSERT INTO `t_menu` VALUES ('cdf113348c5899a193a0edb40252fd7e', null, 'storage', '仓库管理', 'icon-standard-house', '', '5', '');
...
CREATE TABLE `t_storehouse_storage` (
  ...
  `status` enum('enable','disable') default NULL,
  `storage_type_id` varchar(32) default NULL,
  `yes_or_no` enum('yes','no') default NULL,
...
CREATE TABLE `t_storehouse_storage_repair` (
  ...
  CONSTRAINT `t_storehouse_storage_repair_ibfk_1` FOREIGN KEY (`storage_id`) REFERENCES `t_storehouse_storage` (`storage_id`)
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES ('8b25651c2d896297530b64e4b80ec503', 'admin', '超级管理员', '5dc10e7826e648ec6f136974c38f81d0e5e1d0ae', 'e03b1b95ceff4db6', 'enable', 'admin', 'admin@glacier.cn', null, null, '2014-10-16 17:38:53', '127.0.0.1[本地]', '1073', '8b25651c2d896297530b64e4b80ec503', '2014-02-27 02:58:02');
