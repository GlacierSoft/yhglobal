...
CREATE TABLE `t_finance_platform` (
  ...
  `bank_tacitly` enum('no','yes') default NULL,
  `auditor` varchar(32) default NULL,
  `audit_state` enum('author','fail','pass') default NULL,
  `audit_time` datetime default NULL,
  `audit_opinion` varchar(255) default NULL,
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES ('8b25651c2d896297530b64e4b80ec503', 'admin', '超级管理员', '5dc10e7826e648ec6f136974c38f81d0e5e1d0ae', 'e03b1b95ceff4db6', 'enable', 'admin', 'admin@glacier.cn', null, null, '2014-10-30 10:16:03', '127.0.0.1[本地]', '1213', '8b25651c2d896297530b64e4b80ec503', '2014-02-27 02:58:02');
