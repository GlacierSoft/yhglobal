...
CREATE TABLE `t_storehouse_added_service` (
  ...
  `sign_receipt _type` enum('invoice','waybill') default 'waybill' COMMENT '发货单 or  运单',
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES ('8b25651c2d896297530b64e4b80ec503', 'admin', '超级管理员', '5dc10e7826e648ec6f136974c38f81d0e5e1d0ae', 'e03b1b95ceff4db6', 'enable', 'admin', 'admin@glacier.cn', null, null, '2014-11-28 10:01:41', '127.0.0.1[本地]', '1255', '8b25651c2d896297530b64e4b80ec503', '2014-02-27 02:58:02');
