...
INSERT INTO `t_action` VALUES ('a72deab609257a40e24c7678a956d8b3', 'cf0069a898b67f89296c266f33b37e56', '7f89edb759ac1e73e65cdca9d7aa43d8', '增加', 'add', 'icon-standard-pencil-add', 'Button', 'enable', 'glacier.storage_mgr.storage_mgr.storage.addStorage();', '1', '');
INSERT INTO `t_action` VALUES ('a929d879b049795ce53c4a09e0d3699a', 'e1a79f5e3fe94e2e8fbe31fd6579ab9b', '0e90f7504fea42f41a94df7ce26da433', '启用/禁用', 'status', 'icon-standard-pencil-go', 'Button', 'enable', 'glacier.carrier_mgr.carrierRoute_mgr.route.editRoute();', '1', '');
...
INSERT INTO `t_action` VALUES ('b6fd472c308b7323f0ab321f1fc5dfea', 'cf0069a898b67f89296c266f33b37e56', '7f89edb759ac1e73e65cdca9d7aa43d8', '删除', 'del', 'icon-standard-pencil-delete', 'Button', 'enable', 'glacier.storage_mgr.storage_mgr.storage.delStorage();', '3', '');
...
INSERT INTO `t_action` VALUES ('e5a6e202b2b893ec2f2a61cfc4fd352c', 'cf0069a898b67f89296c266f33b37e56', '7f89edb759ac1e73e65cdca9d7aa43d8', '修改', 'edit', 'icon-standard-pencil-go', 'Button', 'enable', 'glacier.storage_mgr.storage_mgr.storage.editStorage();', '2', '');
...
INSERT INTO `t_authority` VALUES ('c87dd7161dbf8777c41b8cbfaa985db4', 'cf0069a898b67f89296c266f33b37e56', 'StorageList_add,StorageList_edit,StorageList_del');
...
-- ----------------------------
INSERT INTO `t_carrier_route` VALUES ('1', '珠海-广州', 'disable', '珠海市香洲区哈工大', '广州市越秀区', 'landCarriage', '2', 'KD000-1', '2014-10-15 13:20:32', '20', 'fullClosed', '2014-10-17 17:14:24', '80.0000', '90.0000', '100.0000', '第二天00:30', '10.0000', '13411381321', '75km', 'pass', '8b25651c2d896297530b64e4b80ec503', null, '2014-10-16 17:18:45', null, '8b25651c2d896297530b64e4b80ec503', '2014-10-16 17:18:50', '8b25651c2d896297530b64e4b80ec503', '2014-10-16 17:18:53');

-- ----------------------------
-- Table structure for `t_carrier_route_copy`
-- ----------------------------
DROP TABLE IF EXISTS `t_carrier_route_copy`;
CREATE TABLE `t_carrier_route_copy` (
  `router_id` varchar(32) NOT NULL,
  `route_name` varchar(32) default NULL,
  `status` enum('enable','disable') default NULL,
  `route_origin` varchar(32) default NULL,
...
-- ----------------------------
-- Records of t_carrier_route_copy
-- ----------------------------
...
INSERT INTO `t_loginlog` VALUES ('5b99452fbe43b0704ff7f1c37a2bc902', '8b25651c2d896297530b64e4b80ec503', '超级管理员', '2014-10-16 17:50:56', '127.0.0.1[本地]', null, null);
...
INSERT INTO `t_loginlog` VALUES ('83e864f6c7329b29a24e9b9d30c56824', '8b25651c2d896297530b64e4b80ec503', '超级管理员', '2014-10-16 17:58:56', '127.0.0.1[本地]', null, null);
...
INSERT INTO `t_menu` VALUES ('cf0069a898b67f89296c266f33b37e56', 'cdf113348c5899a193a0edb40252fd7e', 'storage', '仓库信息管理', 'icon-hamburg-home', '/do/storage/index.htm', '2', '');
...
INSERT INTO `t_operalog` VALUES ('01514079452700d50749cd28ad268477', '资源管理', '操作列表', '增加', '1', '[增加] 操作信息已保存', 'com.glacier.frame.service.system.ActionService', 'addAction', 'ActionList_add', '超级管理员', '2014-10-16 17:55:18');
...
INSERT INTO `t_operalog` VALUES ('2abf14ca1dbe9f475cb3df8de9b901e9', '资源管理', '菜单树', '增加', '0', '英文名称重复', 'com.glacier.frame.service.system.MenuService', 'addMenu', 'MenuTree_add', '超级管理员', '2014-10-16 17:52:13');
...
INSERT INTO `t_operalog` VALUES ('332366dd6016017ba5c304a0298081ea', '资源管理', '操作列表', '增加', '1', '[修改] 操作信息已保存', 'com.glacier.frame.service.system.ActionService', 'addAction', 'ActionList_add', '超级管理员', '2014-10-16 17:56:01');
...
INSERT INTO `t_operalog` VALUES ('670291cd8f34e0ca874e6fc9e5fd92cb', '资源管理', '菜单树', '修改', '1', '[仓库管理] 菜单信息已保存', 'com.glacier.frame.service.system.MenuService', 'editMenu', 'MenuTree_edit', '超级管理员', '2014-10-16 17:53:06');
...
INSERT INTO `t_operalog` VALUES ('7810ea2cd50f3c6772010c1918ea2705', '资源管理', '面板列表', '增加', '1', '[仓库信息列表] 面板信息已保存', 'com.glacier.frame.service.system.PanelService', 'addPanel', 'PanelList_add', '超级管理员', '2014-10-16 17:54:35');
...
INSERT INTO `t_operalog` VALUES ('7f60d55d1ba3816c004baf3b07c693b6', '角色管理', '角色列表', '授权', '1', '权限信息已保存', 'com.glacier.frame.service.system.AuthorityService', 'saveRoleAuths', 'RoleList_auth', '超级管理员', '2014-10-16 17:56:52');
...
INSERT INTO `t_operalog` VALUES ('8d12f8fd2b38ea14ea9802d1388d3c86', '资源管理', '菜单树', '增加', '1', '[仓库信息管理] 菜单信息已保存', 'com.glacier.frame.service.system.MenuService', 'addMenu', 'MenuTree_add', '超级管理员', '2014-10-16 17:54:01');
...
INSERT INTO `t_operalog` VALUES ('997df1a12c69090208b989b938789d82', '下拉项管理', '下拉列表', '增加', '1', '[否] 下拉项值信息已保存', 'com.glacier.frame.service.basicdatas.ParameterOptgroupValueService', 'addOptgroupValue', 'OptgroupValueList_add', '超级管理员', '2014-10-16 17:58:02');
...
INSERT INTO `t_operalog` VALUES ('9e4fb32cfc3b87e7adb0dbee294dc865', '下拉项管理', '下拉项树', '增加', '1', '[是否] 下拉项信息已保存', 'com.glacier.frame.service.basicdatas.ParameterOptgroupService', 'addOptgroup', 'OptgroupTree_add', '超级管理员', '2014-10-16 17:57:38');
...
INSERT INTO `t_operalog` VALUES ('b990aa5ad9b9740dcf0d4ed0c29b6182', '资源管理', '操作列表', '增加', '1', '[删除] 操作信息已保存', 'com.glacier.frame.service.system.ActionService', 'addAction', 'ActionList_add', '超级管理员', '2014-10-16 17:56:34');
...
INSERT INTO `t_operalog` VALUES ('bc5ff83e41f49875390976c1046e2806', '资源管理', '操作列表', '编辑', '1', '[增加] 操作信息已保存', 'com.glacier.frame.service.system.ActionService', 'editAction', 'ActionList_edit', '超级管理员', '2014-10-16 17:56:08');
...
INSERT INTO `t_operalog` VALUES ('c42e1686e21eef710c5492322835f26d', '下拉项管理', '下拉列表', '增加', '1', '[是] 下拉项值信息已保存', 'com.glacier.frame.service.basicdatas.ParameterOptgroupValueService', 'addOptgroupValue', 'OptgroupValueList_add', '超级管理员', '2014-10-16 17:57:52');
...
INSERT INTO `t_panel` VALUES ('7f89edb759ac1e73e65cdca9d7aa43d8', 'cf0069a898b67f89296c266f33b37e56', '仓库信息列表', 'StorageList', '1');
...
INSERT INTO `t_parameter_optgroup` VALUES ('933a66243662c55135146ae02166e726', '113afb2ecac88fe851ad501c53b7d82b', 'yesOrNo', '是否', null, null, '5', '', '8b25651c2d896297530b64e4b80ec503', '2014-10-16 17:57:38', '8b25651c2d896297530b64e4b80ec503', '2014-10-16 17:57:38');
...
INSERT INTO `t_parameter_optgroup_value` VALUES ('652efc5f6dbc3efb221b58f84f4840b9', '933a66243662c55135146ae02166e726', 'yes', '是', 'enable', '1', '', '8b25651c2d896297530b64e4b80ec503', '2014-10-16 17:57:52', '8b25651c2d896297530b64e4b80ec503', '2014-10-16 17:57:52');
...
INSERT INTO `t_parameter_optgroup_value` VALUES ('bb1ab34c83c78542f774514bf38c9772', '933a66243662c55135146ae02166e726', 'no', '否', 'enable', '2', '', '8b25651c2d896297530b64e4b80ec503', '2014-10-16 17:58:02', '8b25651c2d896297530b64e4b80ec503', '2014-10-16 17:58:02');
...
-- ----------------------------
INSERT INTO `t_shipper_member_bank_card` VALUES ('1', '1', '中国工商银行', '借记卡', '12345678903456', 'pass', '8b25651c2d896297530b64e4b80ec503', '该借记卡通过', '2014-10-10 03:52:20', '完美', '8b25651c2d896297530b64e4b80ec503', '2014-10-10 03:52:04', '8b25651c2d896297530b64e4b80ec503', '2014-10-16 11:30:28');
...
-- ----------------------------
INSERT INTO `t_storehouse_storage` VALUES ('48216dbd85198dbeb95f253ad0215c3c', 'ST_STORAGE_2014_10_16_1', '0d8c4ef43c6ce99d0fd3edb140eae202', 'A站冷冻库', 'enable', 'd6dc13121742a3b331dcb6f93d4f4bce', 'no', '2014-10-10 00:00:00', '6', '0', null, '3002', '300', '3002', '300', '1234567', '广东南方职业培训学院', '很冷的仓库。', '8b25651c2d896297530b64e4b80ec503', '2014-10-16 15:30:28', '8b25651c2d896297530b64e4b80ec503', '2014-10-16 17:59:22');
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES ('8b25651c2d896297530b64e4b80ec503', 'admin', '超级管理员', '5dc10e7826e648ec6f136974c38f81d0e5e1d0ae', 'e03b1b95ceff4db6', 'enable', 'admin', 'admin@glacier.cn', null, null, '2014-10-16 17:58:56', '127.0.0.1[本地]', '1075', '8b25651c2d896297530b64e4b80ec503', '2014-02-27 02:58:02');
