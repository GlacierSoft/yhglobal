...
public class StorehouseDamageController {
    ...
    private Object intoIndexPservice() {
        ModelAndView mav = new ModelAndView("storehouse_mgr/storehouseDamage_mgr/storehouseDamage");
        return mav;
    }
	...
	//仓库货品损坏记录信息详情页
   	...
   	private Object intoStorehouseDamageDetailPage(String damageId) {
   	    ModelAndView mav = new ModelAndView("storehouse_mgr/storehouseDamage_mgr/storehouseDamage_detail");
   ...
   //进入货物损坏信息审核页
    ...
    private Object intoAuditStorehouseDamage(String damageId) {
        ModelAndView mav = new ModelAndView("storehouse_mgr/storehouseDamage_mgr/storehouseDamage_audit");
        if(StringUtils.isNotBlank(damageId)){
        	 mav.addObject("storehouseDamageData", storehouseDamageServcie.getStorehouseDamagePro(damageId));
        }
        return mav;
