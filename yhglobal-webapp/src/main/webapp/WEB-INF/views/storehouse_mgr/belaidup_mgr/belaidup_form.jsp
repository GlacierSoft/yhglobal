...
<form id="belaidup_mgr_belaidup_form" method="post" style="padding:15px">
	<table class="formtable" width="800">
		...
		<tr>
			<td>货物单价：</td>
			<td>
				<input id="belaidup_mgr_belaidup_form_belaidupUnitprice" style="width:268px;height: 20px;" name="belaidupUnitprice" value="${belaidupDate.belaidupUnitprice}" required="true" class="easyui-numberbox"/>
			</td>
			<td>货主名称：</td>
			<td>
		...
		<tr>
			<td>入库物品重量：</td>
			<td>
				<input id="belaidup_mgr_belaidup_form_belaidupWeight" name="belaidupWeight"  style="width:268px;height: 20px;" value="${belaidupDate.belaidupWeight}" class="easyui-numberbox" required="true"/>
			</td>
			<td>入库物品体积：</td>
			<td>
				<input id="belaidup_mgr_belaidup_form_belaidupBulk" name="belaidupBulk"  style="width:268px;height: 20px;" value="${belaidupDate.belaidupBulk}" class="easyui-numberbox" required="true"/>
			</td>
		</tr>
		<tr>
			<td>货物仓库费：</td>
			<td>
				<input id="belaidup_mgr_belaidup_form_repertoryPrice" name="repertoryPrice"  style="width:268px;height: 20px;" value="${belaidupDate.repertoryPrice}" class="easyui-numberbox" required="true"/>
			</td>
			<td>货物存货费：</td>
			<td>
				<input id="belaidup_mgr_belaidup_form_stockPrice" name="stockPrice"  style="width:268px;height: 20px;" value="${belaidupDate.stockPrice}" class="easyui-numberbox" required="true"/>
			</td>
		</tr>
		<tr>
			<td>物品包装费：</td>
			<td>
				<input id="belaidup_mgr_belaidup_form_packPrice" name="packPrice"  style="width:268px;height: 20px;" value="${belaidupDate.packPrice}" class="easyui-numberbox" required="true"/>
			</td>
			<td>物品运输费：</td>
			<td>
				<input id="belaidup_mgr_belaidup_form_freightPrice" name="freightPrice"  style="width:268px;height: 20px;" value="${belaidupDate.freightPrice}" class="easyui-numberbox" required="true"/>
			</td>
		</tr>
		<tr>
			<td>起始站：</td>
			<td>
				<input id="belaidup_mgr_belaidup_form_belaidupInitiatin" name="belaidupInitiatin"  style="width:268px;height: 20px;" value="${belaidupDate.belaidupInitiatin}" class="easyui-validatebox spinner" required="true"/>
			</td>
			<td>终点站：</td>
			<td>
				<input id="belaidup_mgr_belaidup_form_belaidupTerminu" name="belaidupTerminu"  style="width:268px;height: 20px;" value="${belaidupDate.belaidupTerminu}" class="easyui-validatebox spinner" required="true"/>
			</td>
		</tr>
		<tr>
			<td>取货方式：</td>
		...
		<tr>
			<td>备注：</td>
			<td colspan="3">
				<textarea id="belaidup_mgr_belaidup_form_remark" name="remark" style="width:690px;" class="spinner formta">${belaidupDate.remark}</textarea>
			</td>
		</tr>
	</table>
</form>
