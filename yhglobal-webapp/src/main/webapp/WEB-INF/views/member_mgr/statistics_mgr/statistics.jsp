...
<script type="text/javascript">
	...
	glacier.member_mgr.statistics_mgr.statistics.statisticsDataGrid = $('#statisticsDataGrid').datagrid({
						...
						columns : [ [ {
							...
							field : 'counttransportation',
							title : '运输总金额',
							sortable : true,
							width : 120
						}, {
							field : 'countinsurance',
							title : '保险费总金额',
							sortable : true,
							width : 120
						}, {
                        ...
                        $.easyui.showDialog({
								title : '【' + rowData.memberId + '】会员统计详情',
								href : ctx+ '/do/memberStatistics/intoDetail.htm?memberId='+ rowData.statisticsId,//从controller请求jsp页面进行渲染
								width : 570,
								height : 360,
								resizable : false,
