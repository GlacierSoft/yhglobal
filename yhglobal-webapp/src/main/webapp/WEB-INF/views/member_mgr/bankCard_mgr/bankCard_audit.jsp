	...
	<table class="detailtable">
		...
		<tr>
		 ...
		 <tr>   
		     <td>审核状态设置：</td>
			 <td colspan="3">
			   <input type="hidden"  name="bankcardId" value="${shipperMemberBankCardData.bankcardId}" />
			   <input id="contractManager_mgr_contractManager_form_auditState" name="auditState" type="radio" value="authstr" /><span>审核中</span>
			   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			   <input id="contractManager_mgr_contractManager_form_auditState" name="auditState" type="radio" value="pass" /><span>审核通过</span>
			   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			   <input id="contractManager_mgr_contractManager_form_auditState" name="auditState" type="radio" value="failure" /><span>审核失败</span>
			 </td>
		</tr>
		<tr>   
