...
<script type="text/javascript">
	...
	glacier.member_mgr.integral_mgr.integral.integralDataGrid = $('#integralDataGrid').datagrid({
		...
		idField:'shipperMemberIntegralId',
		columns:[[
			{
				field:'shipperMemberIntegralId',
				title:'ID',
				checkbox:true
			},{
				field:'memberName',
		...
		onDblClickRow:function(rowIndex, rowData){
			$.easyui.showDialog({
				...
				href : ctx + '/do/memberIntegral/intoDetail.htm?shipperMemberIntegralId='+rowData.shipperMemberIntegralId,//从controller请求jsp页面进行渲染
				width : 530,
				height : 250,
				resizable: false,
		...
		<form id="memberIntegralSearchForm">
			<table>
				<tr>
					...
					<td>积分类型：</td>
					<td><input id="memberIntegralSearchForm_type" name="integralTypeName" style="width: 150px;" class="spinner"/></td>
					<td>改变类型：</td>
