	...
	<div data-options="region:'north',split:true"
		...
		<form id="contractSearchForm">
			<table>
				<tr>
					<td>合同名称：</td>
					<td><input name="contractTypeName" style="width: 80px;"
						class="spinner" /></td>
					<td>类型：</td>
					...
					<td><a href="javascript:void(0);" class="easyui-linkbutton"
						...
						onclick="glacier.member_mgr.contractManager_mgr.contractManager.contractManagerDataGrid.datagrid('load',glacier.serializeObject($('#contractSearchForm')));">查询</a>
						<a href="javascript:void(0);" class="easyui-linkbutton"
						data-options="iconCls:'icon-standard-zoom-out',plain:true"
						onclick="$('#contractSearchForm input').val('');glacier.member_mgr.contractManager_mgr.contractManager.contractManagerDataGrid.datagrid('load',{});">重置条件</a>
					</td>
				</tr>
			</table>
		</form>
