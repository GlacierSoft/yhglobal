...
<script type="text/javascript">
	...
	glacier.finace_mgr.finaceWithdrawMember_mgr.finaceWithdrawMember.finaceWithdrawMemberDataGrid = $('#finaceWithdrawMemberDataGrid').datagrid({
                        ...
                        $.easyui.showDialog({
								...
								href : ctx+ '/do/finaceWithdrawController/intoDetail.htm?withdrawId='+ rowData.withdrawId,//从controller请求jsp页面进行渲染
								width : 560,
								height : 420,
								resizable : false,
			...
			<table>
				<tr>
					...
					<td><a href="javascript:void(0);" class="easyui-linkbutton"
						...
						onclick="glacier.finace_mgr.finaceWithdrawMember_mgr.finaceWithdrawMember.finaceWithdrawMemberDataGrid.datagrid('load',glacier.serializeObject($('#finaceRechargeMemberSearchForm')));">查询</a>
						<a href="javascript:void(0);" class="easyui-linkbutton"
						data-options="iconCls:'icon-standard-zoom-out',plain:true"
						onclick="$('#finaceRechargeMemberSearchForm input').val('');glacier.finace_mgr.finaceWithdrawMember_mgr.finaceWithdrawMember.finaceWithdrawMemberDataGrid.datagrid('load',{});">重置条件</a>
					</td>
				</tr>
			</table>
		</form>
