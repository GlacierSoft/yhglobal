...
<form method="post" style="padding:15px">
	<table class="detailtable">
		...
		<tr>
			<td>充值类型信息审核：</td>
			<td>
			    <input type="hidden" value="${finaceWithdrawMemberData.withdrawId}" name="withdrawId">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;
				<input id="carrier_mgr_carInformation_form_auditState" name="auditState" type="radio" value="failure" /><span>审核失败</span>
			</td>
		</tr>
		<tr>
		   <td valign="top">备注</td>
...
<script type="text/javascript">
	...
	//审核按钮初始化
	if(${finaceWithdrawMemberData.auditState == 'pass'}){
		document.all("carrier_mgr_carInformation_form_auditState")[1].checked=true;
	}else if(${finaceWithdrawMemberData.auditState == 'failure'}){
