...
<form id="carrierCarInformation_mgr_grade_form" method="post" style="padding:10px">
	<table class="detailtable" >
		...
		<tr>
	    	...
	    	<td>承运商等级：</td>
			<td>
				<input id="finace_mgr_rechargeSetCarrier_form_gradeDisplay" style="width:168px;height: 20px;"  value="${finaceRechargeSetMemberData.memberGradeid}" required="true" class="easyui-validatebox spinner" readonly="readonly"/>
			</td>
		</tr>
		<tr>
			<td>审核状态：</td>
