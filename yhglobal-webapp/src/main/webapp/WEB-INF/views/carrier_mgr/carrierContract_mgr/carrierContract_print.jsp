...
<p><textarea rows="15" id="doc1" cols="102">
		...
		甲方：${carrierContractData.carrierDisplay }
		乙方：${carrierContractData.platformId }
...
<script>
  ...
  function CreateOneFormPage(){
		...
		LODOP.ADD_PRINT_TEXT(21,300,300,30,"越海物流平台承运商专属合同\n");
		...
		LODOP.SET_PRINT_STYLEA(0,"ItemType",1);
		LODOP.SET_PRINT_STYLEA(0,"Vorient",1);
		LODOP.ADD_PRINT_TEXT(421,542,260,22,"越海物流承运商合同：第#页/共&页");
