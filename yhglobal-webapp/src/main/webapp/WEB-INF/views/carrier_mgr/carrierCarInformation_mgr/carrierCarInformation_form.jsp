	...
	<table class="formtable" width="750">
		<tr>
			...
			<td>
				...
				<input id="carrier_mgr_carInformation_form_routeName" style="width:268px;height: 20px;" name="routeName" value="${carInfoformationData.routeName}" class="easyui-validatebox spinner" validType="customReg['^\\d+(\\.\\d+)?$','<fmt:message key="public.thisNum.illegal"/>']"  required="true"/>
			</td>
			<td>车辆牌号:</td>
	    	<td>
		...
		<tr>
			<td>车辆长度：</td>
			<td>
				<input id="carrier_mgr_carInformation_form_carLength" validType="customReg['^\\d+(\\.\\d+)?$','<fmt:message key="public.thisNum.illegal"/>']" style="width:268px;height: 20px;" name="carLength" value="${carInfoformationData.carLength}" class="easyui-validatebox spinner" missingMessage="请输入整数，至少为1。单位默认为米（M）" required="true"/>
			</td>
			<td>车辆载重：</td>
			<td>
				<input id="carrier_mgr_carInformation_form_carLoad" validType="customReg['^\\d+(\\.\\d+)?$','<fmt:message key="public.thisNum.illegal"/>']" style="width:268px;height: 20px;" name="carLoad" value="${carInfoformationData.carLoad}" class="easyui-validatebox spinner" missingMessage="请输入整数，至少为1。单位默认为吨（t）" required="true"/>
			</td>
		</tr>
		<tr>
			<td>车辆所在地：</td>
			...
			<td>车辆年龄：</td>
			<td>
				<input id="carrier_mgr_carInformation_form_carAge" validType="customReg['^\\d+(\\.\\d+)?$','<fmt:message key="public.thisNum.illegal"/>']" style="width:268px;height: 20px;" name="carAge" value="${carInfoformationData.carAge}" required="true" class="easyui-validatebox spinner"/>
			</td>
		</tr>
		<tr>
			<td>车辆状态：</td>
