...
<div id="member_mgr_member_form" style="padding:15px;height: 310px">
 <div title="基本信息" style="padding:15px">
    	<fieldset id="user_mgr_user_form_userGenfieldset" style="padding:10px;" class="spinner">
			...
			<td>
		 	...
		 	<td style="padding-left:10px;">班线里程：</td>
    ...
    <div title="详细信息" style="padding:15px">
    	<fieldset id="user_mgr_user_form_connetGenfieldset" style="padding:10px;" class="spinner">
			...
			<td style="padding-left:10px;">车辆箱型：</td>
		...
		<tr> 
			<td>审核备注：</td>
			<td colspan="3"><input class="spinner" style="width:470px"  value="${carrierRouteData.auditOpinion}" readonly="readonly"/></td>
		</tr> 
	 	<tr> 
			<td>班线说明：</td>
			<td colspan="3"><input class="spinner" style="width:470px"  value="${carrierRouteData.remark}" readonly="readonly"/></td>
		</tr> 
			</table>
		</fieldset>
    </div>  
 ...
 <input id="routeid" value="${carrierRouteData.routerId }" type="hidden">
   ...
   <div id="Prew" class="ark-poptip" style="top: 390px;margin-left: 305px;width: 234px;visibility:hidden;"  >
	<div class="ark-poptip-shadow">
		<div class="ark-poptip-container">
			<div class="ark-poptip-arrow ark-poptip-arrow-b">
				<em>◆</em><span>◆</span>
			</div>
 ...
 <div style="margin-left: 445px">查看 <a href="#" style="color:blue; text-decoration:none;" onmouseover="showdiv(this)" onmouseout="hidediv()">[货物发/收区域]</a>
 </div>
		...
		<tr>
			...
			<td>
				<input type="hidden" name="routerId" value="${carrierRouteData.routerId}" />
			 	<input id="carrierRoute_mgr_route_audit_authState" name="auditState" type="radio" value="authstr"  /><span>审核中</span>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				
				<input id="carrierRoute_mgr_route_audit_authState" name="auditState" type="radio" value="pass"  /><span>审核通过</span>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input id="carrierRoute_mgr_route_audit_authState" name="auditState" type="radio" value="failure"  /><span>审核失败</span>
			</td>
		 	</tr>
		<tr>
			<td>审核说明：</td>
...
<script type="text/javascript">
	...
	//审核按钮初始化 
	if(${carrierRouteData.auditState== 'pass'}){
		document.all("carrierRoute_mgr_route_audit_authState")[1].checked=true;
	}else if(${carrierRouteData.auditState == 'failure'}){
		document.all("carrierRoute_mgr_route_audit_authState")[2].checked=true;
	}else{
		document.all("carrierRoute_mgr_route_audit_authState")[0].checked=true;
	}   
	//隐藏层
	function hidediv() {
	$(".te").remove(); 
