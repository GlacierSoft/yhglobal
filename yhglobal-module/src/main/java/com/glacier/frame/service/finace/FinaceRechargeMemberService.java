...
public class FinaceRechargeMemberService {
	...
	public Object updateFinaceMember(String id) {
		...
		if (id != null) {
			...
			financeMember.setMrechageAdd(memberRechargeAdd.add(finaceRechargeMember.getRechargeMoney()));
			financeMember.setMrechageRemain(financeMember.getMrechageRemain().add(finaceRechargeMember.getReceiveMoney()));
