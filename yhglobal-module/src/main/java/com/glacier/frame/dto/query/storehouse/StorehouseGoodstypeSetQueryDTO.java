/*
 * @(#)StorehouseGoodstypeSetDTO.java
 * @author xichao.dong
...
/**
 * @ClassName: StorehouseGoodstypeSetQueryDTO 
 * @Description: TODO(仓库类型查询DTO) 
 * @author wuting
 * @email 920339213@QQ.com
 * @date 2014-10-15
 */
public class StorehouseGoodstypeSetQueryDTO extends StorehouseGoodstypeSet{
   ...
   public String getLoginStartCount() {
	...
	public void setQueryCondition(Criteria queryCriteria){
   	 if(null != this.getGoodstypeName() && StringUtils.isNotBlank(this.getGoodstypeName())){//仓库类型名称Like查询
            queryCriteria.andGoodstypeNameLike("%" + this.getGoodstypeName() + "%");
        }  
