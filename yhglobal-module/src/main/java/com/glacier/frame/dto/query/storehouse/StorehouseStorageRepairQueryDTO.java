/*
 * @(#)StorehouseStorageRepairQueryDTO.java
 * @author xichao.dong
...
/**
 * @ClassName: StorehouseStorageRepairQueryDTO 
 * @Description: TODO(仓库类型查询DTO) 
 * @author wuting
 * @email 920339213@QQ.com
 * @date 2014-10-15
 */
public class StorehouseStorageRepairQueryDTO extends StorehouseStorageRepair{
   ...
   public String getLoginStartCount() {
	...
	public void setQueryCondition(Criteria queryCriteria){
   	 if(null != this.getStorageDisplay() && StringUtils.isNotBlank(this.getStorageDisplay())){//仓库名称Like查询
            queryCriteria.andStorageDisplayLike("%" + this.getStorageDisplay() + "%");
     }  
   	 if(null != this.getRepairStauts()){//维修状态查询
        queryCriteria.andRepairStautsEqualTo(this.getRepairStauts().toString());
   	 }
