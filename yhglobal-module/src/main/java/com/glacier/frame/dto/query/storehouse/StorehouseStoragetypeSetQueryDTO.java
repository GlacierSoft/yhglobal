/*
 * @(#)StorehouseStoragetypeSetDTO.java
 * @author xichao.dong
...
/**
 * @ClassName: StorehouseStoragetypeSetQueryDTO 
 * @Description: TODO(仓库类型查询DTO) 
 * @author wuting
 * @email 920339213@QQ.com
 * @date 2014-10-15
 */
public class StorehouseStoragetypeSetQueryDTO extends StorehouseStoragetypeSet{
   ...
   public String getLoginStartCount() {
	...
	public void setQueryCondition(Criteria queryCriteria){
   	 if(null != this.getStoragetypeName() && StringUtils.isNotBlank(this.getStoragetypeName())){//仓库类型名称Like查询
            queryCriteria.andStoragetypeNameLike("%" + this.getStoragetypeName() + "%");
        }  
