   ...
   <div title="发货区域" style="padding:15px">
    	<fieldset id="user_mgr_user_form_connetGenfieldset" style="padding:20px;" class="spinner">
			...
			<tr>   
			 ...
			 <input type="hidden" name="deliverList[0].deliverGoodsAreaId" value="${carrierRouteData.deliverList[0].deliverGoodsAreaId}" />
			 <input class="spinner"   
			style="height:18px;width:180px"  name="deliverList[0].deliverName" value="${carrierRouteData.deliverList[0].deliverName}"/></td>
			   <td style="padding-left:20px;">价格(次)：</td>
			 <td >
			 	<input class="  easyui-validatebox spinner"   style="height:18px;width:180px" name="deliverList[0].price" 
			 	value="<fmt:formatNumber value="${carrierRouteData.deliverList[0].price}" pattern="#,#00.00"/>"
			 	 />
			  </td>
		    </tr>  
		    <tr>   
			...
			<tr>   
			 ...
			 <td>
			  <input type="hidden" name="deliverList[1].deliverGoodsAreaId" value="${carrierRouteData.deliverList[1].deliverGoodsAreaId}" />
			 <input class="easyui-validatebox spinner"   
			style="height:18px;width:180px"  name="deliverList[1].deliverName" value="${carrierRouteData.deliverList[1].deliverName}"/></td>
			   <td style="padding-left:20px;">价格(次)：</td>
			 <td >
		  ...
		  <tr>   
		     <td>发货区域3：</td>
			 <td><input class="easyui-validatebox spinner"  
			style="height:18px;width:180px"  name="deliverList[2].deliverName" value="${carrierRouteData.deliverList[2].deliverName}"/></td>
			   <td style="padding-left:20px;">价格(次)：</td>
			 <td >
			  <input type="hidden" name="deliverList[2].deliverGoodsAreaId" value="${carrierRouteData.deliverList[2].deliverGoodsAreaId}" />
		  ...
		  <tr>   
		     <td>发货区域4：</td>
			 <td><input class="easyui-validatebox spinner"  
			style="height:18px;width:180px"  name="deliverList[3].deliverName" value="${carrierRouteData.deliverList[3].deliverName}"/></td>
			   <td style="padding-left:20px;">价格(次)：</td>
			 <td >
			  <input type="hidden" name="deliverList[3].deliverGoodsAreaId" value="${carrierRouteData.deliverList[3].deliverGoodsAreaId}" />
		...
		<fieldset id="user_mgr_user_form_connetGenfieldset" style="padding:20px;" class="spinner">
			...
			<tr>   
			 ...
			 <td>
			  <input type="hidden" name="pickUpList[0].pickUpGoodsAreaId" value="${carrierRouteData.pickUpList[0].pickUpGoodsAreaId}" />
			  <input class="easyui-validatebox spinner"   
			style="height:18px;width:180px"  name="pickUpList[0].deliverName" value="${carrierRouteData.pickUpList[0].deliverName}"/></td>
			   <td style="padding-left:20px;">价格(次)：</td>
			 <td >
			...
			<tr>   
		     <td>提货区域2：</td>
			 <td><input class="easyui-validatebox spinner"  
			style="height:18px;width:180px"  name="pickUpList[1].deliverName" value="${carrierRouteData.pickUpList[1].deliverName}"/></td>
			   <td style="padding-left:20px;">价格(次)：</td>
			 <td >
			   <input type="hidden" name="pickUpList[1].pickUpGoodsAreaId" value="${carrierRouteData.pickUpList[1].pickUpGoodsAreaId}" />
			  <input class="  easyui-validatebox spinner"  style="height:18px;width:180px" name="pickUpList[1].price" 
			 	value="<fmt:formatNumber value="${carrierRouteData.pickUpList[1].price}" pattern="#,#00.00"/>"/> 
			  </td>
		  </tr>
		  <tr>   
		     <td>详细地址：</td>
		  ...
		  <tr>   
		     <td>提货区域4：</td>
			 <td><input class="easyui-validatebox spinner" 
			style="height:18px;width:180px"  name="pickUpList[3].deliverName" value="${carrierRouteData.pickUpList[3].deliverName}"/></td>
			   <td style="padding-left:20px;">价格(次)：</td>
			 <td >
			   <input type="hidden" name="pickUpList[3].pickUpGoodsAreaId" value="${carrierRouteData.pickUpList[3].pickUpGoodsAreaId}" />
			  <input class="  easyui-validatebox spinner"  style="height:18px;width:180px" name="pickUpList[3].price" 
			 	value="<fmt:formatNumber value="${carrierRouteData.pickUpList[3].price}" pattern="#,#00.00"/>"/> 
			  </td>
		  </tr>
		  <tr>   
		     <td>详细地址：</td>
